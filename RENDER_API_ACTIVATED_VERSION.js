...
app.get('/api/health', (req, res) => {
  res.json({
    ...
    version: '4.1.0',
    features: {
      nameGenerator: !!process.env.OPENAI_API_KEY,
      domainChecker: !!process.env.GODADDY_API_KEY,
      emailService: !!process.env.SENDGRID_API_KEY,
      smsService: !!process.env.TWILIO_AUTH_TOKEN
    }
  });
});
...
app.listen(PORT, () => {
  ...
  console.log(`Features: Name Generator: ${!!process.env.OPENAI_API_KEY}, Domain Checker: ${!!process.env.GODADDY_API_KEY}`);
});